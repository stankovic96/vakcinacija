...
<div class="container-fluid">
    ...
    <div class="row" id="main">
        <div class="col-12 col-md-2" id="levi-deo">
            <ul class="breadcrumb remove-margin" id="putokaz">
                <li class="breadcrumb-item"><?= anchor("Lekar/pocetniPrikaz", "Izvestaji", 'class = "nav-link"') ?></li>
                <li class="breadcrumb-item"><?= anchor("Lekar/pocetniPrikazUnosenjaNezeljeneReakcijeBezGreske", "Kreiranje izvestaja o reakciji na vakcinu", 'class = "nav-link active"') ?></li>
            </ul>
        ...
        <div class="col-12 col-md-8 remove-padding" id="glavni-sadrzaj">
            <p style = "font-size:26px;">Ulogovan lekar: <?php echo "$ime"." "."$prezime"?></p>
        </div>
