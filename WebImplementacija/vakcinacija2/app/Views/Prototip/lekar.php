        ...
        <div class="row" id="main">
            <div class="col-12 col-md-2" id="levi-deo">
                <ul class="breadcrumb remove-margin" id="putokaz">
                    <li class="breadcrumb-item"><a href="#">Lekar</a></li>
                </ul>
                <nav class="nav flex-column" id="vertikalni-meni">
                    <a href="izvestaj_kreiranje.html" class="nav-link active">Kreiranje izveštaja o reakciji na vakcinaciju</a>
                </nav>
            ...
            <div class="col-12 col-md-8 remove-padding" id="glavni-sadrzaj">
                <p>Lekar: <?php echo $korisnik->getIme()." ".$korisnik->getPrezime();?> </p>
            </div>
