        ...
        <div class="row" id="header">
            ...
            <div class="col-8">
                <nav class="nav">
                    ...
                    <a href="prijava.html" class="nav-link active">Пријава</a>
        ...
        <div class="row" id="main">
            <div class="col-12 col-md-2 remove-padding" id="levi-deo">
                <ul class="breadcrumb remove-margin" id="putokaz">
                    <li class="breadcrumb-item"><a href="prijava.html">Пријава</a></li>
                </ul>
            ...
            <div class="col-12 col-md-8" id="glavni-sadrzaj">
                <form>
                    <div class="form-group">
                        <label for="korime">Корисничко име</label>
                        <input id="korime" class="form-control" type="text" name="korime">
                    </div>
                    <div class="form-group">
